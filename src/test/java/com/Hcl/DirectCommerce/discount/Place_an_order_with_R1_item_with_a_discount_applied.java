package com.Hcl.DirectCommerce.discount;
...
public class Place_an_order_with_R1_item_with_a_discount_applied extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\OrderLifeCycle_discount.xlsx";
    String testscenario="Place_an_order_with_R1_item_with_a_discount_applied";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="Place_an_order_with_R1_item_with_a_discount_applied")
    public void R1_OA() throws Throwable{
		...
		try {	
			...
			keyvalue=(HashMap<Object, Object>)Excel_Reader.getrowvalue(sFilePath,"OrderLifeCycle_discount", testscenario);
			...
			String discount=keyvalue.get("discount").toString();
			PaymentDetails.Additionaldisc1(discount);
		    ...
		    CustomizeReport("Place_an_order_with_R1_item_with_a_discount_applied", "pass", "Place_an_order_with_R1_item_with_a_discount_applied");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_order_with_R1_item_with_a_discount_applied", "fail", "Place_an_order_with_R1_item_with_a_discount_applied");	
		}
	}
