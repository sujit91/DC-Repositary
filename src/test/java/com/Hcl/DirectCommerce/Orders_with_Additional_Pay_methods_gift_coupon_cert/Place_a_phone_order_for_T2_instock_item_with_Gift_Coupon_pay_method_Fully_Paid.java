...
public class Place_a_phone_order_for_T2_instock_item_with_Gift_Coupon_pay_method_Fully_Paid extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\OrderManagement\\OrderlifeCycle_Additional_Pay_methods.xlsx";
    String testscenario="Place_a_phone_order_for_T2_instock_item_with_Gift_Coupon_pay_method_Fully_Paid";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="Place_a_phone_order_for_T2_instock_item_with_Gift_Coupon_pay_method_Fully_Paid")
    public void T2_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_a_phone_order_for_T2_instock_item_with_Gift_Coupon_pay_method_Fully_Paid", "pass", "Place_a_phone_order_for_T2_instock_item_with_Gift_Coupon_pay_method_Fully_Paid");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_a_phone_order_for_T2_instock_item_with_Gift_Coupon_pay_method_Fully_Paid", "fail", "Place_a_phone_order_for_T2_instock_item_with_Gift_Coupon_pay_method_Fully_Paid");	
		}
	}
