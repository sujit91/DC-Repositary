...
public class Verify_Modify_order_by_adding_new_items_k1 extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\\\modifyorder.xlsx";
    String testscenario="Verify_Modify_order_by_adding_new_items_k1";
    ...
    public void K1_OA() throws Throwable{
		...
		try {	
			...
			*/
		    ...
		    CustomizeReport("Verify_Modify_order_by_adding_new_items_k1", "pass", "Verify_Modify_order_by_adding_new_items_k1");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Verify_Modify_order_by_adding_new_items_k1", "fail", "Verify_Modify_order_by_adding_new_items_k1");	
		}
	}
