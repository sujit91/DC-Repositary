...
public class Verify_Modify_order_by_adding_new_items_k3 extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\\\modifyorder.xlsx";
    String testscenario="Verify_Modify_order_by_adding_new_items_k3";
    ...
    public void K3_OA() throws Throwable{
		...
		try {	
			...
			*/
		    ...
		    CustomizeReport("Verify_Modify_order_by_adding_new_items_k3", "pass", "Verify_Modify_order_by_adding_new_items_k3");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Verify_Modify_order_by_adding_new_items_k3", "fail", "Verify_Modify_order_by_adding_new_items_k3");	
		}
	}
