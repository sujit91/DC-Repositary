...
public class Verify_Modify_order_by_adding_new_items_k2 extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\modifyorder.xlsx";
    String testscenario="Verify_Modify_order_by_adding_new_items_k2";
    ...
    public void K1_OA() throws Throwable{
		...
		try {	
			...
			*/
		    ...
		    CustomizeReport("Verify_Modify_order_by_adding_new_items_k2", "pass", "Verify_Modify_order_by_adding_new_items_k2");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Verify_Modify_order_by_adding_new_items_k2", "fail", "Verify_Modify_order_by_adding_new_items_k2");	
		}
	}
