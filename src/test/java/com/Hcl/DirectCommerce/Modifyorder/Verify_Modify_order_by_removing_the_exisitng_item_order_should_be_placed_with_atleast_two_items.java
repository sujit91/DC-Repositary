...
public class Verify_Modify_order_by_removing_the_exisitng_item_order_should_be_placed_with_atleast_two_items extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\modifyorder.xlsx";
    String testscenario="Verify_Modify_order_by_removing_the_exisitng_item_order_should_be_placed_with_atleast_two_items";
    ...
    public void R1_OA() throws Throwable{
		...
		try {		
		    ...
		    CustomizeReport("Verify_Modify_order_by_removing_the_exisitng_item_order_should_be_placed_with_atleast_two_items", "pass", "Verify_Modify_order_by_removing_the_exisitng_item_order_should_be_placed_with_atleast_two_items");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Verify_Modify_order_by_removing_the_exisitng_item_order_should_be_placed_with_atleast_two_items", "fail", "Verify_Modify_order_by_removing_the_exisitng_item_order_should_be_placed_with_atleast_two_items");	
		}
	}
