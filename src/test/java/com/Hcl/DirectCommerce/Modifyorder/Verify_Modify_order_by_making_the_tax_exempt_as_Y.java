...
import com.Hcl.DirectCommerce.uiActions.OrderRecap;
import com.Hcl.DirectCommerce.uiActions.additionalInfo;
import com.Hcl.DirectCommerce.uiActions.customerInformation;
import com.Hcl.DirectCommerce.utility.Utility;

public class Verify_Modify_order_by_making_the_tax_exempt_as_Y extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\modifyorder.xlsx";
    String testscenario="Verify_Modify_order_by_making_the_tax_exempt_as_Y";
    ...
    public void R1_OA() throws Throwable{
		...
		try {		
			...
			//=====clcik on additional info=====
			additionalInfo additionalInfo=PageFactory.initElements(driver, additionalInfo.class);
			additionalInfo.clickOnAdditionalInfoTab();
			additionalInfo.selectTaxoption("Yes");
			//===provide shiping details=======
			customerInfn.clickOnShippingdetailTab();
			
			customerInfn.clickOnModify();
			OrderRecap OrderRecap=PageFactory.initElements(driver, OrderRecap.class);
			OrderRecap.getSaletaxvalue("0");
		    ...
		    CustomizeReport("Verify_Modify_order_by_making_the_tax_exempt_as_Y", "pass", "Verify_Modify_order_by_making_the_tax_exempt_as_Y");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Verify_Modify_order_by_making_the_tax_exempt_as_Y", "fail", "Verify_Modify_order_by_making_the_tax_exempt_as_Y");	
		}
	}
