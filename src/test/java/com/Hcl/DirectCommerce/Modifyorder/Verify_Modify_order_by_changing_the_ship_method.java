...
public class Verify_Modify_order_by_changing_the_ship_method extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\modifyorder.xlsx";
    String testscenario="Verify_Modify_order_by_changing_the_ship_method";
    ...
    public void R1_OA() throws Throwable{
		...
		try {		
			...
			String ShippingAddress2=keyvalue.get("ShippingAddress2").toString();
			
			customerInfn.selectshipMethod(ShippingAddress2);
		    ...
		    CustomizeReport("Verify_Modify_order_by_changing_the_ship_method", "pass", "Verify_Modify_order_by_changing_the_ship_method");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Verify_Modify_order_by_changing_the_ship_method", "fail", "Verify_Modify_order_by_changing_the_ship_method");	
		}
	}
