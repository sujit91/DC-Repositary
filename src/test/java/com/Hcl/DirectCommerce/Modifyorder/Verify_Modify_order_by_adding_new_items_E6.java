...
public class Verify_Modify_order_by_adding_new_items_E6 extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\modifyorder.xlsx";
    String testscenario="Verify_Modify_order_by_adding_new_items_E6";
    ...
    public void E4_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Verify_Modify_order_by_adding_new_items_E6", "pass", "Verify_Modify_order_by_adding_new_items_E6");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Verify_Modify_order_by_adding_new_items_E6", "fail", "Verify_Modify_order_by_adding_new_items_E6");	
		}
	}
