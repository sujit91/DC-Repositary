...
public class Verify_Modify_order_by_adding_new_items_E5 extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\modifyorder.xlsx";
    String testscenario="Verify_Modify_order_by_adding_new_items_E5";
    ...
    @Test(priority=1)
    public void E4_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Verify_Modify_order_by_adding_new_items_E5", "pass", "Verify_Modify_order_by_adding_new_items_E5");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Verify_Modify_order_by_adding_new_items_E5", "fail", "Verify_Modify_order_by_adding_new_items_E5");	
		}
	}
