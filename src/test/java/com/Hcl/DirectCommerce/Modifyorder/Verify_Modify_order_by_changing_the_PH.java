...
public class Verify_Modify_order_by_changing_the_PH extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\modifyorder.xlsx";
    String testscenario="Verify_Modify_order_by_changing_the_PH";
    ...
    public void R1_OA() throws Throwable{
		...
		try {		
			...
			String phoverridereason=keyvalue.get("phoverridereason").toString();
			customerInfn.enterPhoverride("1", phoverridereason);
		    ...
		    CustomizeReport("Verify_Modify_order_by_changing_the_PH", "pass", "Verify_Modify_order_by_changing_the_PH");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Verify_Modify_order_by_changing_the_PH", "fail", "Verify_Modify_order_by_changing_the_PH");	
		}
	}
