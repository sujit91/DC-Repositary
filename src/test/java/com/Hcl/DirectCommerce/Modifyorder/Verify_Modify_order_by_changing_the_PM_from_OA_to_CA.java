...
public class Verify_Modify_order_by_changing_the_PM_from_OA_to_CA extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\modifyorder.xlsx";
    String testscenario="Verify_Modify_order_by_changing_the_PM_from_OA_to_CA";
    ...
    public void R1_OA() throws Throwable{
		...
		try {		
			...
			PaymentDetails.enterRemitamount("2");
		    ...
		    CustomizeReport("Verify_Modify_order_by_changing_the_PM_from_OA_to_CA", "pass", "Verify_Modify_order_by_changing_the_PM_from_OA_to_CA");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Verify_Modify_order_by_changing_the_PM_from_OA_to_CA", "fail", "Verify_Modify_order_by_changing_the_PM_from_OA_to_CA");	
		}
	}
