...
public class Verify_Modify_order_by_modifying_the_exisitng_item_price extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\modifyorder.xlsx";
    String testscenario="Verify_Modify_order_by_modifying_the_exisitng_item_price";
    ...
    public void R1_OA() throws Throwable{
		...
		try {		
		    ...
		    CustomizeReport("Verify_Modify_order_by_modifying_the_exisitng_item_price", "pass", "Verify_Modify_order_by_modifying_the_exisitng_item_price");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Verify_Modify_order_by_modifying_the_exisitng_item_price", "fail", "Verify_Modify_order_by_modifying_the_exisitng_item_price");	
		}
	}
