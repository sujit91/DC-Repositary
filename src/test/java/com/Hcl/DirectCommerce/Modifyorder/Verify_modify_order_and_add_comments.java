...
public class Verify_modify_order_and_add_comments extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\modifyorder.xlsx";
    String testscenario="Verify_modify_order_and_add_comments";
    ...
    public void R1_OA() throws Throwable{
		...
		try {		
		    ...
		    CustomizeReport("Verify_modify_order_and_add_comments", "pass", "Verify_modify_order_and_add_comments");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Verify_modify_order_and_add_comments", "fail", "Verify_modify_order_and_add_comments");	
		}
	}
