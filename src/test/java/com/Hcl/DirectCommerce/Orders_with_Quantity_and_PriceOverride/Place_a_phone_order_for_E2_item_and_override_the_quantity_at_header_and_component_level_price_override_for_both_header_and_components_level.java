package com.Hcl.DirectCommerce.Orders_with_Quantity_and_PriceOverride;
...
public class Place_a_phone_order_for_E2_item_and_override_the_quantity_at_header_and_component_level_price_override_for_both_header_and_components_level extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\OrderManagement\\Orders_with_Quantity_and_PriceOverride.xlsx";
    String testscenario="Place_a_phone_order_for_E2_item_and_override_the_quantity_at_header_and_component_level_price_override_for_both_header_and_components_level";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="Place_a_phone_order_for_E2_item_and_override_the_quantity_at_header_and_component_level_price_override_for_both_header_and_components_level")
    public void E2_OA() throws Throwable{
		...
		try {	
			...
			//======modify qty in header level======
			String Modifyqty=keyvalue.get("Modifyqty").toString();
			OrderDetails.modifyQtyOnly(Modifyqty);
			//====modify price in header level======
			String ModifyPrice=keyvalue.get("ModifyPrice").toString();
			OrderDetails.PriceOverrideE2popup(ModifyPrice);
			String overrideReason=keyvalue.get("overrideReason").toString();
			OrderDetails.PriceOverrideReasoninE2popup(overrideReason);
			
			String verifyprice=keyvalue.get("verifyprice").toString();
			//=======================verify the price=================
			OrderDetails.verifyPriceOverride(verifyprice);
			//===modify the qty======
			OrderDetails.modifyQuantity("10");
			//=============price override component lavel=============
			String ModifyPrice2=keyvalue.get("ModifyPrice2").toString();
			OrderDetails.PriceOverride(ModifyPrice2);
			OrderDetails.PriceOverrideReason(overrideReason);
		    ...
		    CustomizeReport("Place_a_phone_order_for_E2_item_and_override_the_quantity_at_header_and_component_level_price_override_for_both_header_and_components_level", "pass", "Place_a_phone_order_for_E2_item_and_override_the_quantity_at_header_and_component_level_price_override_for_both_header_and_components_level");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_a_phone_order_for_E2_item_and_override_the_quantity_at_header_and_component_level_price_override_for_both_header_and_components_level", "fail", "Place_a_phone_order_for_E2_item_and_override_the_quantity_at_header_and_component_level_price_override_for_both_header_and_components_level");	
		}
	}
