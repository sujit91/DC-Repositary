...
public class Place_a_phone_order_for_K3_in_stock_item_and_override_the_quantity_and_price extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\OrderManagement\\Orders_with_Quantity_and_PriceOverride.xlsx";
    String testscenario="Place_a_phone_order_for_K3_in_stock_item_and_override_the_quantity_and_price";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="Place_a_phone_order_for_K3_in_stock_item_and_override_the_quantity_and_price")
    public void K3_OA() throws Throwable{
		...
		try {	
			...
			if (orderstatus.contains(Staus)) {	
				logExtentReport("Both Status is same");
			} else {
				logExtentReportFail("Both Status is not same");
			}
		    CustomizeReport("Place_a_phone_order_for_K3_in_stock_item_and_override_the_quantity_and_price", "pass", "Place_a_phone_order_for_K3_in_stock_item_and_override_the_quantity_and_price");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_a_phone_order_for_K3_in_stock_item_and_override_the_quantity_and_price", "fail", "Place_a_phone_order_for_K3_in_stock_item_and_override_the_quantity_and_price");	
		}
	}
