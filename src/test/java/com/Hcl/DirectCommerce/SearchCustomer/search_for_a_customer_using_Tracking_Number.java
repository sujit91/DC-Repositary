...
public class search_for_a_customer_using_Tracking_Number extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_Tracking_Number";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_Tracking_Number")
    public void CS_020() throws Throwable{
		...
		try {	
			...
			//====fatch db details from sql server for a OX id  number=======
			...
			String oxnumber=Dbscript.EmailValidationsSQL(dbQuery, columnName);	
			//===remove first 2 character=======================
			String OX=Utility.removeCharacter(oxnumber).trim();		
			...
			dashboard.provideSearchFieldValueAndClickSearch(OX);
		    ...
		    CustomizeReport("search_for_a_customer_using_Tracking_Number", "pass", "search_for_a_customer_using_Tracking_Number");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_Tracking_Number", "fail", "search_for_a_customer_using_Tracking_Number");	
		}
	}
