...
public class search_for_a_customer_using_valid_Email_Address extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_valid_Email_Address";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_valid_Email_Address")
    public void CS_008() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("search_for_a_customer_using_valid_Email_Address", "pass", "search_for_a_customer_using_valid_Email_Address");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_valid_Email_Address", "fail", "search_for_a_customer_using_valid_Email_Address");	
		}
	}
