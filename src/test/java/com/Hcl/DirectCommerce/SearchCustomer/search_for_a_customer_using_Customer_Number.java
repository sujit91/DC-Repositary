...
public class search_for_a_customer_using_Customer_Number extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_Customer_Number";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_Customer_Number")
    public void CS_016() throws Throwable{
		...
		try {	
			...
			String value=Dbscript.EmailValidationsSQL(dbQuery, columnName);	
			...
			dashboard.provideSearchFieldValueAndClickSearch(value);
			CustomerSearch cust=PageFactory.initElements(driver,CustomerSearch.class);
			cust.validateCustomer(Fname);	
		    CustomizeReport("search_for_a_customer_using_Customer_Number", "pass", "search_for_a_customer_using_Customer_Number");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_Customer_Number", "fail", "search_for_a_customer_using_Customer_Number");	
		}
	}
