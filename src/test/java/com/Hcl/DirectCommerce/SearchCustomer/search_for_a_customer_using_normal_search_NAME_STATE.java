...
public class search_for_a_customer_using_normal_search_NAME_STATE extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_normal_search_NAME_STATE";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_normal_search_NAME_STATE")
    public void CS_003() throws Throwable{
		...
		CustomizeReport("search_for_a_customer_using_normal_search_NAME_STATE", "pass", "search_for_a_customer_using_normal_search_NAME_STATE");
		Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_normal_search_NAME_STATE", "fail", "search_for_a_customer_using_normal_search_NAME_STATE");	
		}
	}
