...
public class search_for_a_customer_using_Serial_Number extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_Serial_Number";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_Serial_Number")
    public void CS_028() throws Throwable{
		...
		try {	
			...
			//====fatch db details from sql server for a Serial number=======
			...
			String Serial=Dbscript.EmailValidationsSQL(dbQuery, columnName);	
			//===remove first 2 character=======================
			String SN=Utility.removeCharacter(Serial).trim();		
			...
			dashboard.provideSearchFieldValueAndClickSearch(SN);
		    ...
		    CustomizeReport("search_for_a_customer_using_Serial_Number", "pass", "search_for_a_customer_using_Serial_Number");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_Serial_Number", "fail", "search_for_a_customer_using_Serial_Number");	
		}
	}
