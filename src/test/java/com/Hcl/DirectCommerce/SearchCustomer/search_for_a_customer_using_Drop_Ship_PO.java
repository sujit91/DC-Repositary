...
public class search_for_a_customer_using_Drop_Ship_PO extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_Drop_Ship_PO";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_Drop_Ship_PO")
    public void CS_023() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("search_for_a_customer_using_Drop_Ship_PO", "pass", "search_for_a_customer_using_Drop_Ship_PO");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_Drop_Ship_PO", "fail", "search_for_a_customer_using_Drop_Ship_PO");	
		}
	}
