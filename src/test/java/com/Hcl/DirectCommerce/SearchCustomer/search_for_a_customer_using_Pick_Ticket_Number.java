...
public class search_for_a_customer_using_Pick_Ticket_Number extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_Pick_Ticket_Number";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_Pick_Ticket_Number")
    public void CS_027() throws Throwable{
		...
		try {	
			...
			//====fatch db details from sql server for a Pick_Ticket number=======
			...
			String Pick_Ticket=Dbscript.EmailValidationsSQL(dbQuery, columnName);	
			//===remove first 2 character=======================
			String PT=Utility.removeCharacter(Pick_Ticket).trim();		
			...
			dashboard.provideSearchFieldValueAndClickSearch(PT);
		    ...
		    CustomizeReport("search_for_a_customer_using_Pick_Ticket_Number", "pass", "search_for_a_customer_using_Pick_Ticket_Number");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_Pick_Ticket_Number", "fail", "search_for_a_customer_using_Pick_Ticket_Number");	
		}
	}
