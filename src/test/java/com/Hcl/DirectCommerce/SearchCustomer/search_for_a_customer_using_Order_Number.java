...
public class search_for_a_customer_using_Order_Number extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_Order_Number";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_Order_Number")
    public void CS_016() throws Throwable{
		...
		try {	
			...
			//====fatch db details from sql server for a customer number=======
			...
			String ordernumber=Dbscript.EmailValidationsSQL(dbQuery, columnName);	
			...
			String exeQuery = Utility.ReplaceValue(dbQuery2, "order", ordernumber);
			String exeQuery2 = Utility.ReplaceValue(dbQuery3, "order", ordernumber);
		    ...
		    CustomizeReport("search_for_a_customer_using_Order_Number", "pass", "search_for_a_customer_using_Order_Number");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_Order_Number", "fail", "search_for_a_customer_using_Order_Number");	
		}
	}
