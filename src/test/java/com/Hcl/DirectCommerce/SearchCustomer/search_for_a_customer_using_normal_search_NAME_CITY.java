...
public class search_for_a_customer_using_normal_search_NAME_CITY extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_normal_search_NAME_CITY";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_normal_search_NAME_CITY")
    public void CS_006() throws Throwable{
