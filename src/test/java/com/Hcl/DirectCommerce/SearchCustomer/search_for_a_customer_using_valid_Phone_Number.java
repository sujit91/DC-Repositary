...
public class search_for_a_customer_using_valid_Phone_Number extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_valid_Phone_Number";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_valid_Phone_Number")
    public void CS_013() throws Throwable{
		...
		try {	
			...
			dashboard.verifyFilterField(Fname);
		    CustomizeReport("search_for_a_customer_using_valid_Phone_Number", "pass", "search_for_a_customer_using_valid_Phone_Number");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_valid_Phone_Number", "fail", "search_for_a_customer_using_valid_Phone_Number");	
		}
	}
