...
public class search_for_a_customer_using_Auto_PO_Number extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_Auto_PO_Number";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_Auto_PO_Number")
    public void CS_021() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("search_for_a_customer_using_Auto_PO_Number", "pass", "search_for_a_customer_using_Auto_PO_Number");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_Auto_PO_Number", "fail", "search_for_a_customer_using_Auto_PO_Number");	
		}
	}
