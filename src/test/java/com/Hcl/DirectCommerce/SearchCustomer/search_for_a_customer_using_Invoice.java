...
public class search_for_a_customer_using_Invoice extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_Invoice";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_Invoice")
    public void CS_025() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("search_for_a_customer_using_Invoice", "pass", "search_for_a_customer_using_Invoice");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_Invoice", "fail", "search_for_a_customer_using_Invoice");	
		}
	}
