...
public class search_for_a_customer_using_PO_Number extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_PO_Number";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_PO_Number")
    public void CS_018() throws Throwable{
		...
		try {	
			...
			//====fatch db details from sql server for a PO number=======
			...
			String ponumber=Dbscript.EmailValidationsSQL(dbQuery, columnName);	
			//===remove first 2 character=======================
			String PO=Utility.removeCharacter(ponumber).trim();		
			String columnName3=keyvalue.get("columnName3").toString();
			String dbQuery2=keyvalue.get("dbQuery2").toString();
			String ordernumber=Dbscript.EmailValidationsSQL(dbQuery2, columnName3);				
			...
			dashboard.provideSearchFieldValueAndClickSearch(PO);
		    ...
		    CustomizeReport("search_for_a_customer_using_PO_Number", "pass", "search_for_a_customer_using_PO_Number");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_PO_Number", "fail", "search_for_a_customer_using_PO_Number");	
		}
	}
