...
public class search_for_a_customer_using_Membership_Number extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_Membership_Number";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_Membership_Number")
    public void CS_026() throws Throwable{
		...
		try {	
			...
			//====fatch db details from sql server for a membership number=======
			...
			String membership=Dbscript.EmailValidationsSQL(dbQuery, columnName);	
			//===remove first 2 character=======================
			String MB=Utility.removeCharacter(membership).trim();		
			...
			dashboard.provideSearchFieldValueAndClickSearch(MB);
		    ...
		    CustomizeReport("search_for_a_customer_using_Membership_Number", "pass", "search_for_a_customer_using_Membership_Number");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_Membership_Number", "fail", "search_for_a_customer_using_Membership_Number");	
		}
	}
