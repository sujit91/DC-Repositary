...
public class search_for_a_customer_using_normal_search_NAME_ZIPCODE extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="search_for_a_customer_using_normal_search_NAME_ZIPCODE";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="search_for_a_customer_using_normal_search_NAME_ZIPCODE")
    public void CS_004() throws Throwable{
		...
		CustomizeReport("search_for_a_customer_using_normal_search_NAME_ZIPCODE", "pass", "search_for_a_customer_using_normal_search_NAME_ZIPCODE");
		Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("search_for_a_customer_using_normal_search_NAME_ZIPCODE", "fail", "search_for_a_customer_using_normal_search_NAME_ZIPCODE");	
		}
	}
