...
public class place_a_phone_order_for_K1_item_with_DI_pay_method_online_authorize extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\OrderManagement\\Orders_with_credit_card_as_paymethod.xlsx";
    String testscenario="place_a_phone_order_for_K1_item_with_DI_pay_method_online_authorize";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="place_a_phone_order_for_K1_item_with_DI_pay_method_online_authorize")
    public void K1_DI() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("place_a_phone_order_for_K1_item_with_DI_pay_method_online_authorize", "pass", "place_a_phone_order_for_K1_item_with_DI_pay_method_online_authorize");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("place_a_phone_order_for_K1_item_with_DI_pay_method_online_authorize", "fail", "place_a_phone_order_for_K1_item_with_DI_pay_method_online_authorize");	
		}
	}
