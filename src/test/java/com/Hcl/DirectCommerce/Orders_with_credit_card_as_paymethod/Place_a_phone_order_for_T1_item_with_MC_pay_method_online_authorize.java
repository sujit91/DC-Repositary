...
public class Place_a_phone_order_for_T1_item_with_MC_pay_method_online_authorize extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\OrderManagement\\Orders_with_credit_card_as_paymethod.xlsx";
    String testscenario="Place_a_phone_order_for_T1_item_with_MC_pay_method_online_authorize";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="Place_a_phone_order_for_T1_item_with_MC_pay_method_online_authorize")
    public void R1_VI() throws Throwable{
		...
		try {	
			...
			if (!DI_NETWORK_REF_ID.contains("/^([^0-9]*)$/")) {	
				logExtentReport("DI_NETWORK_REF_ID_COLUMN IS VALIDATED SUCCESSFULLY");
			} else {
				logExtentReportFail("DI_NETWORK_REF_ID_COLUMN IS NOT VALIDATED SUCCESSFULLY");
			}
			
		    CustomizeReport("Place_a_phone_order_for_T1_item_with_MC_pay_method_online_authorize", "pass", "Place_a_phone_order_for_T1_item_with_MC_pay_method_online_authorize");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_a_phone_order_for_T1_item_with_MC_pay_method_online_authorize", "fail", "Place_a_phone_order_for_T1_item_with_MC_pay_method_online_authorize");	
		}
	}
