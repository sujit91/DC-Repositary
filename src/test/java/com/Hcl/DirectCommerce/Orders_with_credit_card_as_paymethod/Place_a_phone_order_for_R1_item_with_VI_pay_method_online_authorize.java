...
public class Place_a_phone_order_for_R1_item_with_VI_pay_method_online_authorize extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\OrderManagement\\Orders_with_credit_card_as_paymethod.xlsx";
    String testscenario="Place_a_phone_order_for_R1_item_with_VI_pay_method_online_authorize";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="Place_a_phone_order_for_R1_item_with_VI_pay_method_online_authorize")
    public void R1_VI() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_a_phone_order_for_R1_item_with_VI_pay_method_online_authorize", "pass", "Place_a_phone_order_for_R1_item_with_VI_pay_method_online_authorize");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_a_phone_order_for_R1_item_with_VI_pay_method_online_authorize", "fail", "Place_a_phone_order_for_R1_item_with_VI_pay_method_online_authorize");	
		}
	}
