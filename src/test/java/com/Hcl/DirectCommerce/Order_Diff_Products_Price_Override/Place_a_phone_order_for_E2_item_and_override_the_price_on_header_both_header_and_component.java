package com.Hcl.DirectCommerce.Order_Diff_Products_Price_Override;
...
public class Place_a_phone_order_for_E2_item_and_override_the_price_on_header_both_header_and_component extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\OrderManagement\\Order_Diff_Products_Price_Override.xlsx";
    String testscenario="Place_a_phone_order_for_E2_item_and_override_the_price_on_header_both_header_and_component";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="Place_a_phone_order_for_E2_item_and_override_the_price_on_header_both_header_and_component")
    public void E1_OA() throws Throwable{
		...
		try {	
			...
			//=========price override in header lavel================
		    ...
		    CustomizeReport("Place_a_phone_order_for_E2_item_and_override_the_price_on_header_both_header_and_component", "pass", "Place_a_phone_order_for_E2_item_and_override_the_price_on_header_both_header_and_component");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_a_phone_order_for_E2_item_and_override_the_price_on_header_both_header_and_component", "fail", "Place_a_phone_order_for_E2_item_and_override_the_price_on_header_both_header_and_component");	
		}
	}
