...
public class Place_a_phone_order_for_E6_item_and_override_the_price_on_header extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\OrderManagement\\Order_Diff_Products_Price_Override.xlsx";
    String testscenario="Place_a_phone_order_for_E6_item_and_override_the_price_on_header";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="Place_a_phone_order_for_E6_item_and_override_the_price_on_header")
    public void E6_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_a_phone_order_for_E6_item_and_override_the_price_on_header", "pass", "Place_a_phone_order_for_E6_item_and_override_the_price_on_header");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_a_phone_order_for_E6_item_and_override_the_price_on_header", "fail", "Place_a_phone_order_for_E6_item_and_override_the_price_on_header");	
		}
	}
