...
public class Place_an_order_for_T2_product_WITHOUT_STOCK extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\OrderManagement\\OrderLifeCycle_DiffProducts.xlsx";
    String testscenario="Place_an_order_for_T2_product_WITHOUT_STOCK";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="Place_an_order_for_T2_product_WITHOUT_STOCK")
    public void T2_OUTOFSTOCK_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_an_order_for_T2_product_WITHOUT_STOCK", "pass", "Place_an_order_for_T2_product_WITHOUT_STOCK");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_order_for_T2_product_WITHOUT_STOCK", "fail", "Place_an_order_for_T2_product_WITHOUT_STOCK");	
		}
	}
