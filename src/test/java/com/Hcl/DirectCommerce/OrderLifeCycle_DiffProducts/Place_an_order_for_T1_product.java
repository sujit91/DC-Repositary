...
public class Place_an_order_for_T1_product extends TestBase{
    ...
    public void T1_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_an_order_for_T1_product", "pass", "Place_an_order_for_T1_product");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_order_for_T1_product", "fail", "Place_an_order_for_T1_product");	
		}
	}
