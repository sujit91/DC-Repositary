...
public class Place_an_order_for_C1_product extends TestBase{
    ...
    public void C1_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_an_order_for_C1_product", "pass", "Place_an_order_for_C1_product");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_order_for_C1_product", "fail", "Place_an_order_for_C1_product");	
		}
	}
