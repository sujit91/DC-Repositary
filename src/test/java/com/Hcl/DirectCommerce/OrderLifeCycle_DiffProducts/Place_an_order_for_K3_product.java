...
public class Place_an_order_for_K3_product extends TestBase{
    ...
    public void K3_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_an_order_for_K3_product", "pass", "Place_an_order_for_K3_product");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_order_for_K3_product", "fail", "Place_an_order_for_K3_product");	
		}
	}
