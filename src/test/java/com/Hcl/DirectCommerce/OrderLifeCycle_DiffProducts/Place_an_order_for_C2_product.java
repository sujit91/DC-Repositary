...
public class Place_an_order_for_C2_product extends TestBase{
    ...
    public void C2_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_an_order_for_C2_product", "pass", "Place_an_order_for_C2_product");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_order_for_C2_product", "fail", "Place_an_order_for_C2_product");	
		}
	}
