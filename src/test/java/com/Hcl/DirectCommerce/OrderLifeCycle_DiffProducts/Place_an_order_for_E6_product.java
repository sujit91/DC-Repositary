...
public class Place_an_order_for_E6_product extends TestBase{
    ...
    public void E6_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_an_order_for_E6_product", "pass", "Place_an_order_for_E6_product");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_order_for_E6_product", "fail", "Place_an_order_for_E6_product");	
		}
	}
