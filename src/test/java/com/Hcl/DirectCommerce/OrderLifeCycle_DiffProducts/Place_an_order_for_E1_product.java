...
public class Place_an_order_for_E1_product extends TestBase{
    ...
    public void E1_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_an_order_for_E1_product", "pass", "Place_an_order_for_E1_product");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_order_for_E1_product", "fail", "Place_an_order_for_E1_product");	
		}
	}
