...
public class Place_an_order_for_E5_product extends TestBase{
    ...
    public void E5_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_an_order_for_E5_product", "pass", "Place_an_order_for_E5_product");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_order_for_E5_product", "fail", "Place_an_order_for_E5_product");	
		}
	}
