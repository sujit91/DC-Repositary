...
public class Place_an_order_for_K4_product extends TestBase{
    ...
    public void K4_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_an_order_for_K4_product", "pass", "Place_an_order_for_K4_product");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_order_for_K4_product", "fail", "Place_an_order_for_K4_product");	
		}
	}
