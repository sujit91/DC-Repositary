...
public class Place_an_order_for_K2_product extends TestBase{
    ...
    public void K2_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_an_order_for_K2_product", "pass", "Place_an_order_for_K2_product");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_order_for_K2_product", "fail", "Place_an_order_for_K2_product");	
		}
	}
