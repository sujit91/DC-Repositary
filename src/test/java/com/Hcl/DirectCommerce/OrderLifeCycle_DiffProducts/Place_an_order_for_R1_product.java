...
public class Place_an_order_for_R1_product extends TestBase{
    ...
    public void R1_OA() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_an_order_for_R1_product", "pass", "Place_an_order_for_R1_product");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_order_for_R1_product", "fail", "Place_an_order_for_R1_product");	
		}
	}
