...
public class Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_Amex extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\Order_with_Credit_Card_and_Gift_Certificate.xlsx";
    String testscenario="Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_Amex";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_Amex")
    public void R1_AX() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_Amex", "pass", "Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_Amex");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_Amex", "fail", "Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_Amex");	
		}
	}
