...
public class Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_MasterCard extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\Order_with_Credit_Card_and_Gift_Certificate.xlsx";
    String testscenario="Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_MasterCard";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_MasterCard")
    public void R1_VI() throws Throwable{
		...
		try {	
		    ...
		    CustomizeReport("Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_MasterCard", "pass", "Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_MasterCard");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_MasterCard", "fail", "Place_order_for_R1_item_with_Gift_Certificate_and_partially_paid_with_MasterCard");	
		}
	}
