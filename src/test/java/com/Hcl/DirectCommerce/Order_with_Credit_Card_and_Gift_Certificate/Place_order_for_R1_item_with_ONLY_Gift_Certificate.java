...
public class Place_order_for_R1_item_with_ONLY_Gift_Certificate extends TestBase{
	 String sFilePath = System.getProperty("user.dir")+"\\TestData\\Order_with_Credit_Card_and_Gift_Certificate.xlsx";
	    String testscenario="Place_order_for_R1_item_with_ONLY_Gift_Certificate";
	    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
	    
	    @Test(description="Place_order_for_R1_item_with_ONLY_Gift_Certificate")
	    public void K2_OA() throws Throwable{
			...
			try {	
				...
				String cert = keyvalue.get("Coupon").toString();
				PaymentDetails.selectTenderType(Tendertype);
				PaymentDetails.ProvidegiftCoupon(cert);
			    ...
			    CustomizeReport("Place_order_for_R1_item_with_ONLY_Gift_Certificate", "pass", "Place_order_for_R1_item_with_ONLY_Gift_Certificate");
			    Report=true;
		} finally {
			if (Report==false) {
				CustomizeReport("Place_order_for_R1_item_with_ONLY_Gift_Certificate", "fail", "Place_order_for_R1_item_with_ONLY_Gift_Certificate");	
			}
		}
