...
public class Place_an_Order_for_K1_item_with_Gift_certificate_and_partially_paid_with_Open_account extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\Order_with_Credit_Card_and_Gift_Certificate.xlsx";
    String testscenario="Place_an_Order_for_K1_item_with_Gift_certificate_and_partially_paid_with_Open_account";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="Place_an_Order_for_K1_item_with_Gift_certificate_and_partially_paid_with_Open_account")
    public void K1_OA() throws Throwable{
		...
		try {	
			...
			String amount=keyvalue.get("PartialAmount").toString();
			PaymentDetails.ProvideAmount(amount);
			//===validation is missing as its not implemented===
		    ...
		    CustomizeReport("Place_an_Order_for_K1_item_with_Gift_certificate_and_partially_paid_with_Open_account", "pass", "Place_an_Order_for_K1_item_with_Gift_certificate_and_partially_paid_with_Open_account");
		    Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("Place_an_Order_for_K1_item_with_Gift_certificate_and_partially_paid_with_Open_account", "fail", "Place_an_Order_for_K1_item_with_Gift_certificate_and_partially_paid_with_Open_account");	
		}
	}
