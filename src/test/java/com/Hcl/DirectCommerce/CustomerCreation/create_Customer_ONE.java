...
public class create_Customer_ONE extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="create_Customer_ONE";
    ...
    public void CC01() throws Throwable{
		...
		CustomizeReport("create_Customer_ONE", "pass", "create_Customer_ONE");
		Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("create_Customer_ONE", "fail", "create_Customer_ONE");
		}
	}
