...
public class create_Customer_THREE extends TestBase{
    String sFilePath = System.getProperty("user.dir")+"\\TestData\\CustomerSearch\\CustomerSearch.xlsx";
    String testscenario="create_Customer_THREE";
    HashMap<Object, Object> keyvalue = new HashMap<Object, Object>();
    
    @Test(description="create_Customer_THREE")
    public void CC03() throws Throwable{
		...
		CustomizeReport("create_Customer_THREE", "pass", "create_Customer_THREE");
		Report=true;
	} finally {
		if (Report==false) {
			CustomizeReport("create_Customer_THREE", "fail", "create_Customer_THREE");	
		}
	}
